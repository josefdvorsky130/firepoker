...
* Clone the repository: `git clone https://github.com/hamidsardar/Firepoker.git`
...
Think you've found a bug or have a new feature to suggest? Let us know! [Open an issue](https://github.com/hamidsardar/Firepoker/issues).
